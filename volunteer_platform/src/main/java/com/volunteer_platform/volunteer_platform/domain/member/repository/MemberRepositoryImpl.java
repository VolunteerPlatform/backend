...
public class MemberRepositoryImpl implements MemberRepositoryCustom {
    ...
    public MemberDto findMemberProfileCustom(Long id) {
        ...
        return em.createQuery(
                "select new com.volunteer_platform.volunteer_platform.domain.member.dto.MemberDto(m.userName, m.kakaoId, mi.birthday, mi.gender, mi.phoneNumber, mi.userRealName, m1.centerName, m1.idOf1365)" +
                        " from Member m" +
